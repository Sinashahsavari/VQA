...
if __name__ == '__main__':
    ...
    if os.path.exists(train_ids_file) and os.path.exists(val_ids_file):
        ...
        print('train_imgids',len(train_imgids))
        val_imgids = cPickle.load(open(val_ids_file))
    else:
        train_imgids = utils.load_imageid('/datasets/ee285f-public/VQA2017/train2014')
        print('train_imgids',len(train_imgids))
        val_imgids = utils.load_imageid('/datasets/ee285f-public/VQA2017/val2014')
...
# 
    ...
    print('whole loop',sina_counter)
    print('train if',sina_counter2)
